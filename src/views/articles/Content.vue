      ...
      <div class="col-md-9 left-col pull-right">
        <div class="panel article-body content-body">
          ...
          <div class="article-meta text-center">
            ...
            <abbr>{{ $filters.moment(date, 'from') }}</abbr>
          </div>
          <div class="entry-content">
            ...
            <!--打赏窗口开始-->
            <Modal :show="showQrcode" @update:show="showQrcode = val" class="text-center">
              ...
              <div>
                ...
                <div class="payment-qrcode inline-block">
                  ...
                  <p>
                    ...
                    <img src="https://cdn.learnku.com/uploads/images/201803/25/2/g3CFVs0h7B.jpeg?imageView2/2/w/1024/h/0" width="160"></p>
                </div>
              </div>
                    ...
                    <div class="infos">
                      <div class="media-heading">
                        ...
                        <div class="meta">
                          ...
                          <span> ⋅ </span>
                          <abbr class="timeago">
                            {{ $filters.moment( comment.date,'from') }}
                          </abbr>
                        </div>
                      </div>
...
export default {
  ...
  created() {
    ...
    const article = this.$store.getters.getArticleById(articleId) //从store中获取数据
    ...
    if (article) {
      ...
      //name => name 表示不认识的就返回原值
      this.content =  emoji.emojify(content, name => name)
      this.date = date
  ...
  mounted() {
    ...
    if (this.auth) {
      ...
      simplemde.codemirror.on('change', () => {
        ...
        this.commentHtml = emoji.emojify(this.commentMarkdown, name => name)
      })
    ...
    renderComments(comments) {
      if (Array.isArray(comments)) {
        ...
        for (let comment of newComments) {
          ...
          comment.content = emoji.emojify(comment.content, name => name)
        }
